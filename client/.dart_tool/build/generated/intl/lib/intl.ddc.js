define(['dart_sdk', 'packages/intl/src/plural_rules', 'packages/intl/number_symbols', 'packages/intl/number_symbols_data', 'packages/intl/date_symbols'], function(dart_sdk, packages__intl__src__plural_rules, packages__intl__number_symbols, packages__intl__number_symbols_data, packages__intl__date_symbols) {
  ...
  dart.defineLazy(CT, {
    ...
    get C2() {
      return C2 = dart.fn(intl.Intl._throwLocaleError, StringToString());
    },
    get C3() {
    ...
    get C9() {
      return C9 = dart.fn(plural_rules.localeHasPluralRules, StringTobool());
    },
    get C11() {
    ...
    get C19() {
      return C19 = dart.fn(intl._CompactNumberFormat._forDecimal, NumberSymbolsToString());
    },
    get C20() {
      return C20 = dart.fn(intl.NumberFormat.localeExists, dynamicTobool());
    },
    get C21() {
      return C21 = dart.fn(intl.DateFormat.localeExists, dynamicTobool());
    }
  });
  ...
  intl.Intl = class Intl extends core.Object {
    ...
    static _pluralRule(locale, howMany) {
      ...
      let verifiedLocale = intl.Intl.verifiedLocale(locale, C9 || CT.C9, {onFailure: dart.fn(locale => "default", dynamicToString())});
