define(['dart_sdk'], function(dart_sdk) {
  ...
  const NAME$ = dart.privateName(date_symbols, "DateSymbols.NAME");
  const ERAS$ = dart.privateName(date_symbols, "DateSymbols.ERAS");
  const ERANAMES$ = dart.privateName(date_symbols, "DateSymbols.ERANAMES");
  const NARROWMONTHS$ = dart.privateName(date_symbols, "DateSymbols.NARROWMONTHS");
  const STANDALONENARROWMONTHS$ = dart.privateName(date_symbols, "DateSymbols.STANDALONENARROWMONTHS");
  const MONTHS$ = dart.privateName(date_symbols, "DateSymbols.MONTHS");
  const STANDALONEMONTHS$ = dart.privateName(date_symbols, "DateSymbols.STANDALONEMONTHS");
  const SHORTMONTHS$ = dart.privateName(date_symbols, "DateSymbols.SHORTMONTHS");
  const STANDALONESHORTMONTHS$ = dart.privateName(date_symbols, "DateSymbols.STANDALONESHORTMONTHS");
  const WEEKDAYS$ = dart.privateName(date_symbols, "DateSymbols.WEEKDAYS");
  const STANDALONEWEEKDAYS$ = dart.privateName(date_symbols, "DateSymbols.STANDALONEWEEKDAYS");
  const SHORTWEEKDAYS$ = dart.privateName(date_symbols, "DateSymbols.SHORTWEEKDAYS");
  const STANDALONESHORTWEEKDAYS$ = dart.privateName(date_symbols, "DateSymbols.STANDALONESHORTWEEKDAYS");
  const NARROWWEEKDAYS$ = dart.privateName(date_symbols, "DateSymbols.NARROWWEEKDAYS");
  const STANDALONENARROWWEEKDAYS$ = dart.privateName(date_symbols, "DateSymbols.STANDALONENARROWWEEKDAYS");
  const SHORTQUARTERS$ = dart.privateName(date_symbols, "DateSymbols.SHORTQUARTERS");
  const QUARTERS$ = dart.privateName(date_symbols, "DateSymbols.QUARTERS");
  const AMPMS$ = dart.privateName(date_symbols, "DateSymbols.AMPMS");
  const DATEFORMATS$ = dart.privateName(date_symbols, "DateSymbols.DATEFORMATS");
  const TIMEFORMATS$ = dart.privateName(date_symbols, "DateSymbols.TIMEFORMATS");
  const DATETIMEFORMATS$ = dart.privateName(date_symbols, "DateSymbols.DATETIMEFORMATS");
  const AVAILABLEFORMATS$ = dart.privateName(date_symbols, "DateSymbols.AVAILABLEFORMATS");
  const FIRSTDAYOFWEEK$ = dart.privateName(date_symbols, "DateSymbols.FIRSTDAYOFWEEK");
  const WEEKENDRANGE$ = dart.privateName(date_symbols, "DateSymbols.WEEKENDRANGE");
  const FIRSTWEEKCUTOFFDAY$ = dart.privateName(date_symbols, "DateSymbols.FIRSTWEEKCUTOFFDAY");
  const ZERODIGIT$ = dart.privateName(date_symbols, "DateSymbols.ZERODIGIT");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["date_symbols.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAaS;;;;;;IAIH;;;;;;IAGA;;;;;;IAGA;;;;;;IAIA;;;;;;IAGA;;;;;;IAOA;;;;;;IAGA;;;;;;IAIA;;;;;;IAGA;;;;;;IAMA;;;;;;IAGA;;;;;;IAIA;;;;;;IAGA;;;;;;IAIA;;;;;;IAGA;;;;;;IAGA;;;;;;IAGA;;;;;;IAGA;;;;;;IAGA;;;;;;IAGA;;;;;;