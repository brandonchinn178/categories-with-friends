define(['dart_sdk', 'packages/path/path'], function(dart_sdk, packages__path__path) {
  ...
  let C0;
  const frames$ = dart.privateName(trace$, "Trace.frames");
  const original$ = dart.privateName(trace$, "Trace.original");
  ...
  const frames$0 = dart.privateName(vm_trace, "VMTrace.frames");
  ...
  const uri$ = dart.privateName(frame$, "Frame.uri");
  const line$ = dart.privateName(frame$, "Frame.line");
  const column$ = dart.privateName(frame$, "Frame.column");
  const member$ = dart.privateName(frame$, "Frame.member");
  ...
  const uri = dart.privateName(unparsed_frame, "UnparsedFrame.uri");
  const line = dart.privateName(unparsed_frame, "UnparsedFrame.line");
  const column = dart.privateName(unparsed_frame, "UnparsedFrame.column");
  const isCore = dart.privateName(unparsed_frame, "UnparsedFrame.isCore");
  const library = dart.privateName(unparsed_frame, "UnparsedFrame.library");
  const package$ = dart.privateName(unparsed_frame, "UnparsedFrame.package");
  const location = dart.privateName(unparsed_frame, "UnparsedFrame.location");
  const member$0 = dart.privateName(unparsed_frame, "UnparsedFrame.member");
  ...
  const _thunk$ = dart.privateName(lazy_trace, "_thunk");
  ...
  const traces$ = dart.privateName(chain$, "Chain.traces");
  chain$.Chain = class Chain extends core.Object {
    ...
    static current(level) {
      ...
      return new lazy_chain.LazyChain.new(dart.fn(() => {
        ...
        return new chain$.Chain.new((t3 = JSArrayOfTrace().of([first]), t3[$addAll](chain.traces[$skip](1)), t3));
      }, VoidToChain()));
    }
  ...
  const _thunk$0 = dart.privateName(lazy_chain, "_thunk");
